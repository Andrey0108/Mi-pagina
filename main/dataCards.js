const cards = [
  {
    ...
    estreno: "27/03/2014",
    descripcion:
      "Tada Banri es un joven universitario que acude a Tokio con el objetivo de articlear una nueva vida, cortando cualquier lazo de su pasado. Este cambio se debe a un accidente que sufrió al día siguiente de su graduación de la preparatoria, accidente que le provocó una terrible amnesia.",
  },
  {
    slider: [
    ...
    estreno: "02/04/2006",
    descripcion:
      "La historia sigue al personaje del título, Haruhi Suzumiya, una estudiante de preparatoria que inconscientemente puede cambiar la realidad y sus extrañas travesuras con su club de la escuela, la 'Brigada SOS', que ella fundó para investigar sucesos misteriosos.",
  },
  {
    slider: [
  ...
  },
  {
    ...
    estreno: "05/01/2018",
    descripcion:
      "Los espíritus malignos deambulan por la Tierra y la humanidad se sumerge en el caos. Un niño demonio y Ryo, su amigo misterioso, en una guerra despiadada contra el mal. Ve todo lo que quieras. Esta innovadora adaptación recibió dos premios Anime de Crunchyroll: anime del año y mejor director para Masaaki Yuasa.",
  },
  {
    slider: [
    ...
    estreno: "02/05/1997",
    descripcion:
      "El manga relata los esfuerzos de los misteriosos y secretos Caballeros Protestantes Reales, la organización «Hellsing» y sus combates contra vampiros, ghouls y otros enemigos sobrenaturales que amenazan al Reino Unido de Gran Bretaña.",
  },
  {
    slider: [
    ...
    estreno: "07/01/2019",
    descripcion:
      "Dororo es un anime que sigue la historia de Hyakkimaru, un niño que su padre concede a cuarenta y ocho demonios las cuarenta y ocho partes de su cuerpo. Hyakkimaru fue abandonado, lo rescató un doctor que lo vuelve a componer con partes de cadáveres de niños. Ya adulto decide buscar sus partes perdidas.",
  },
];
